...
method_dicts_land = [
    ...
    {'short': 'punbound', 'long': 'party-seats-unbounded','title': "Party seats unbounded"},
    {'short': 'adjfix',   'long': 'adjustment-as-fixed', 'title': "Adj.seats as fixed"},
    {'short': 'relmarg',  'long': 'max-relative-margin', 'title': "Relative margin"},
    {'short': 'absmarg',  'long': 'max-absolute-margin', 'title': "Absolute margin"},
    {'short': 'optimal',  'long': 'alternating-scaling', 'title': 'Alternating scaling'},
    {'short': 'optlp',    'long': 'optimal-lp',          'title': 'Optimal LP'},
    ...
    {'short': 'switchse', 'long': 'switching_se',        'title': "Swedish seat switching"},
